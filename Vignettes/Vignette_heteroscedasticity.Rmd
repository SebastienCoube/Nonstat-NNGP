---
title: "Toy example heteroscedasticity"
...
```{r, dpi = 25}
Bidart::plot_pointillist_painting(locs, latent_field_scale)
```

Let's plot the latent field for the noise variance...
```{r, dpi = 25}
Bidart::plot_pointillist_painting(locs, latent_field_noise)
```
...
Convergence is checked with diagnostic_plots() (not done here to save some html size)
