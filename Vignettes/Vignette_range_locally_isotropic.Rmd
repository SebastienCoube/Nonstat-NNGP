---
title: "Vignette range locally isotropic"
output: md_document
---
...
Convergence is checked with diagnostic_plots() like before.
...
Lo and behold, the two ``anisotropy" components are low ! (normally this pops up automatically)
```{r}
...
Lo and behold, the marginal variance's log scale is low ! (those plots pop up automatically)
```{r}
Bidart::plot_log_scale(log_scale_arrays =
                         list(
