...
KL = get_KL_basis(locs = observed_locs, n_KL = 8, covfun_name = "matern15_isotropic", covparms = c(1, 1, .0001))
...
KL_ = get_KL_basis(locs = locs, n_KL = 8, covfun_name = "matern15_isotropic", covparms = c(1, 1, .0001))
...
plot(locs[,1], log_range)
points(pred$predicted_locs[,1], pred$summaries$log_range[1,], col =2)

plot(locs[,1], latent_field, cex = .3, pch = 15)
