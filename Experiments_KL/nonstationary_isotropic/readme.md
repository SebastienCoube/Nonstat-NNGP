These are the scripts needed to reproduce the empirical Kullback-Leibler results presented in the paper. You will need to get yourself a SLURM cluster to run them. 
