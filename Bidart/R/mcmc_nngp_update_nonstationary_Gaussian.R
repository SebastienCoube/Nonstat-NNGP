...
#    {
#      
#      plot(locs[observation_idx ,1], log_scale)
#      points(data$locs[,1], log(state$sparse_chol_and_stuff$scale), col = 2, pch = 16)
#      
#      plot(locs[observation_idx
#                ,1], log_noise_variance)
#      points(data$observed_locs[,1], log(state$sparse_chol_and_stuff$noise), col=2, pch = 16)
#    }
    #cat(paste(iter, " "))
    #########
    # Range #
